...
{
    public class DeleteClientByIdAsyncTest : IClassFixture<Fixture>
    {
        private Fixture _fixture;
        public DeleteClientByIdAsyncTest(Fixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public async Task When_ModelStateIsInvalid_ReturnsBadRequest()
        {
            ...
            var result = await _fixture.Controller.DeleteClientById(1);
        ...
        [Fact]
        public async Task When_Success_ReturnsOk()
        {
            #region Arrange
